...
//    }
    ...
    private Button btnSignOut, btnRevokeAccess, btnMainAct;
    private ImageView imgProfilePic;
    private TextView txtName, txtEmail;
    private LinearLayout llProfileLayout;
    private ImageView splashImg;

//    public LoginActivity(Button btnSignOut) {
...
//    }
    ...
    private void updateUI(boolean isSignedIn) {
        if (isSignedIn) {
            ...
            btnMainAct.setVisibility(View.VISIBLE);
            ...
            btnMainAct.setVisibility(View.GONE);
